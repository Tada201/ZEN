...
const helperPath = new URL("../src/atlas/hooks/stream/chatChunkBuffer.ts", import.meta.url);
...
assert(
  helperSource.includes('return type === "reasoning" ? "thought" : type || "text";'),
...
const strippedSource = helperSource.replace(/^import .+;\r?\n/gm, "");
