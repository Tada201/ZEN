...
const escalation = readFileSync(new URL("../src-tauri/crates/zen-agent/src/runner/streaming.rs", import.meta.url), "utf8");
...
const loop = readFileSync(new URL("../src-tauri/crates/zen-agent/src/runner/turn_loop.rs", import.meta.url), "utf8") +
...
const lifecycle = readFileSync(new URL("../src-tauri/crates/zen-agent/src/runner/lifecycle.rs", import.meta.url), "utf8");
