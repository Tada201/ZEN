...
const eventBus = readFileSync("src-tauri/crates/zen-agent/src/event_bus.rs", "utf8");
const escalation = readFileSync("src-tauri/crates/zen-agent/src/runner/streaming.rs", "utf8");
