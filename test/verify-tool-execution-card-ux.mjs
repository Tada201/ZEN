...
assert(cardSource.includes("min-h-8 w-full min-w-0 items-center gap-2 rounded-md border"), "collapsed cards should render as compact execution rows");
assert(cardSource.includes("min-w-0 flex-1 truncate") && cardSource.includes("truncate"), "tool names and action text should not push the row layout wider during streaming");
