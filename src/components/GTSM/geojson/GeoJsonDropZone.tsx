...
export const GeoJsonDropZone: React.FC<GeoJsonDropZoneProps> = ({ onFileDropped, children }) => {
  ...
  return (
    ...
    >
      {isDragActive && (
        <div className="absolute inset-0 z-50 m-3 flex items-center justify-center border border-dashed border-primary bg-card pointer-events-none transition-all duration-200">
          <div className="border border-border bg-background px-5 py-4 text-center shadow-2xl">
