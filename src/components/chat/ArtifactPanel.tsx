...
import { X, PanelLeft, RotateCw, Copy, Check, Download, Maximize2, Minimize2, Search, Inbox, Archive, ExternalLink } from 'lucide-react';
...
export function ArtifactPanel({ isEmbedded = false }: { isEmbedded?: boolean }) {
    ...
    const renderPreview = () => {
        ...
        if (activeArtifact.type === 'ui' || activeArtifact.type === 'html' || activeArtifact.type === 'openui') {
            return (
        ...
        if (activeArtifact.type === 'diagram' || activeArtifact.language === 'mermaid') {
            return (
                    ...
                    {!activeArtifact ? (
                        ...
                        <div className="flex items-center gap-4">
                            <div className={cn(
                                ...
                                activeArtifact.type === 'diagram' ? "bg-emerald-500/10 border-emerald-500/30 text-emerald-400" : 
                                "bg-amber-500/10 border-amber-500/30 text-amber-400"
                            )}>
                                <WorkbenchIcon 
                                    name={activeArtifact.type === 'code' ? "code-2" : 
                                          activeArtifact.type === 'diagram' ? "share-2" : 
                                          activeArtifact.type === 'ui' ? "layout" : "file-text"} 
                                    size={16} 
                                />
                            </div>
                                            ...
                                            <div className={cn(
                                                ...
                                                <WorkbenchIcon 
                                                    name={art.type === 'code' ? "code-2" : 
                                                          art.type === 'diagram' ? "share-2" : 
                                                          art.type === 'ui' ? "layout" : "file-text"} 
                                                    size={14} 
                                                />
                                            </div>
