        ...
        return (
            <div className="relative w-full group">
                ...
                <input
                    ...
                    className={cn(
                        'h-9 w-full rounded-md bg-background border border-border px-3 text-xs text-foreground transition-all duration-200 outline-none hover:border-border-strong focus-visible:border-primary focus-visible:ring-1 focus-visible:ring-primary/20 placeholder:text-muted-foreground/60',
                        IconProp && 'pl-9',
                        className
                    )}
                    {...props}
