...
export const SettingsSchema = z.object({
  ...
  welcomePageQuality: z.enum(["low", "high", "image", "none"]).default("high"),
  bootEnabled: z.boolean().default(true),
  bootDuration: z.number().min(500).max(5000).default(2500),
  bootDurationMs: z.number().min(500).max(5000).default(3200),
  ...
  sttWhisperModel: z.string().default("ggml-base.en.bin"),
  ...
  googleBaseUrl: z.string().default("https://generativelanguage.googleapis.com/v1beta/openai"),
  ...
  togetherBaseUrl: z.string().default("https://api.together.xyz/v1"),
  perplexityBaseUrl: z.string().default("https://api.perplexity.ai"),
  qwenBaseUrl: z.string().default("https://dashscope.aliyuncs.com/compatible-mode/v1"),
