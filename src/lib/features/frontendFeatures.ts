...
export const FRONTEND_FEATURES = [
  ...
  { id: "right.analytics", label: "Analytics", maturity: "production", surfaces: ["rightRail"], defaultVisible: true, risk: "none", rightPanelTabId: "analytics", icon: Activity },
  ...
  { id: "right.workflows", label: "Workflows", maturity: "production", surfaces: ["rightRail"], defaultVisible: true, risk: "none", rightPanelTabId: "workflows", icon: Zap },
  ...
  { id: "right.space", label: "Operational Space", maturity: "production", surfaces: ["rightRail"], defaultVisible: true, risk: "heavy-runtime", rightPanelTabId: "space", icon: MapIcon },
  { id: "right.memory", label: "Memory", maturity: "production", surfaces: ["rightRail"], defaultVisible: true, risk: "none", rightPanelTabId: "memory", icon: Cpu },
