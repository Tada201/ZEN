...
pub enum AgentEvent {
    ...
    ContextBreakdown(crate::context_breakdown::ContextBreakdownPayload),
}
...
impl AgentEvent {
    ...
    pub fn emit_to(&self, events: &dyn EventSink) {
        ...
        crate::event_snapshot::record(event_name, &flat_payload);
            ...
            loop {
                match rx.recv().await {
                    Ok(event) => {
                        ...
                        crate::event_snapshot::record(event_name, &payload);
