...
impl Runner {
    pub fn new(
        ...
        Self {
            ...
            // `crate::cache::ttl_for_tool`. Anything not on that allowlist
    ...
    pub(super) async fn record_and_emit_intermediate_commentary(
        ...
        let segments = {
            ...
            crate::event_bus::SubagentCommentarySegment::snapshot(&commentary)
        };
    ...
    pub(super) fn emit_owned_chat_error(
        &self,
        payload: crate::event_bus::ChatErrorPayload,
    ) {
