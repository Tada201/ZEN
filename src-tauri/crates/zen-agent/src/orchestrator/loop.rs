...
use crate::event_bus::{AgentEvent, ChatDonePayload, ChatErrorPayload};
use crate::task_queue::TaskQueue;
use crate::types::AgentResponse;
use zen_db::models::{ChatMessage, OrchestrationPlan, OrchestrationTask};
use zen_db::queries;
            ...
            for task in &breakdown.tasks {
                ...
                let otask = OrchestrationTask {
                    ...
                    priority: match task.priority {
                        crate::task::TaskPriority::Critical => 4,
                        crate::task::TaskPriority::High => 3,
                        crate::task::TaskPriority::Medium => 2,
                        crate::task::TaskPriority::Low => 1,
                    },
            ...
            .await
        {
            ...
            Err(e) => {
                ...
                let _ = self.emit(AgentEvent::ChatError(
                    crate::event_bus::ChatErrorPayload {
                        chat_id: chat_id.to_string(),
                        error: error_msg,
                        recoverable: false,
                    },
