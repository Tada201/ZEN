...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat::upsert_execution_trace,
            commands::chat::get_execution_trace,
            commands::chat::list_execution_traces,
            commands::chat::send_message,
            commands::chat::delete_chat,
            commands::chat::update_chat_title,
            commands::chat::generate_session_title,
            commands::chat::repair_mermaid,
            commands::chat::repair_chart,
            ...
            commands::chat::cancel_subagent,
            commands::chat::pause_chat,
            ...
            commands::agent::set_voice_display_model,
            commands::agent::set_agent_model,
            commands::agent::set_agent_reasoning,
            ...
            commands::mcp::mcp_get_inventory,
            commands::mcp::mcp_upsert_server,
            commands::mcp::mcp_set_enabled,
            commands::mcp::mcp_remove_server,
            commands::mcp::mcp_reconnect,
            commands::mcp::mcp_list_pending,
            commands::mcp::mcp_approve_server,
            commands::mcp::mcp_deny_server,
            commands::mcp::mcp_authorize_oauth,
            commands::mcp::mcp_list_resources,
            commands::mcp::mcp_list_resource_templates,
