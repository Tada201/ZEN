...
use crate::agent::middleware::EnrichmentContext;
use crate::agent::runner::config::RunConfig;
use crate::agent::runner::helpers::{estimate_conversation_tokens, estimate_tokens};
...
pub fn tool_catalog_totals(exposed_tools: &[crate::tools::ToolInfo]) -> ToolCatalogTotals {
...
pub fn layer_totals(ctx: &EnrichmentContext) -> LayerTotals {
    ...
    for entry in &ctx.section_log {
        ...
        match entry.id {
            crate::agent::middleware::ContextSectionId::SafetyPreamble
            | crate::agent::middleware::ContextSectionId::AgentInstructions
            | crate::agent::middleware::ContextSectionId::Time
            | crate::agent::middleware::ContextSectionId::UiRules
            | crate::agent::middleware::ContextSectionId::DrawingCanvas
            | crate::agent::middleware::ContextSectionId::GraphSession
            | crate::agent::middleware::ContextSectionId::GraphSessionState
            | crate::agent::middleware::ContextSectionId::DirectBoard
            | crate::agent::middleware::ContextSectionId::ToolSystem
            | crate::agent::middleware::ContextSectionId::TodoChecklist
            | crate::agent::middleware::ContextSectionId::PatchRules
            | crate::agent::middleware::ContextSectionId::AgentRoles => {
                system_prompt += tokens;
            }
            crate::agent::middleware::ContextSectionId::SkillsCatalog => {
                skills_catalog = Some(tokens);
            }
            crate::agent::middleware::ContextSectionId::SemanticRecall => {
                recall = Some(tokens);
            }
            crate::agent::middleware::ContextSectionId::PreviousSummary
            | crate::agent::middleware::ContextSectionId::CurrentSummary => {
                summary += tokens;
            }
            crate::agent::middleware::ContextSectionId::Conversation => {
...
fn build_section(entry: &crate::agent::middleware::ContextSectionEntry) -> ContextSection {
    use crate::agent::middleware::{ContextSectionId as S, SectionStatus};
...
fn from_internal(
    id: crate::agent::middleware::ContextSectionId,
) -> ContextSectionId {
    use crate::agent::middleware::ContextSectionId as S;
    match id {
